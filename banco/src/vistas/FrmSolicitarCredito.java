...
public class FrmSolicitarCredito extends JFrame {
    ...
    public FrmSolicitarCredito() {
        ...
        JLabel lbl2 = new JLabel("Monto a Solicitar:"); lbl2.setForeground(Color.WHITE);
        txtMonto = new JTextField(); txtMonto.setEnabled(false);

        btnSolicitar = new JButton("Solicitar");
        btnSolicitar.setBackground(new Color(11, 232, 129)); btnSolicitar.setEnabled(false);
        ...
        panel.add(btnIniciar); panel.add(new JLabel(""));
        panel.add(lbl2); panel.add(txtMonto);
        panel.add(btnSolicitar); panel.add(btnRegresar);
    ...
    private void iniciarSesion() {
        ...
        if (daoCuenta.iniciarSesion(num)) {
            ...
            txtMonto.setEnabled(true); btnSolicitar.setEnabled(true);
        } else {
