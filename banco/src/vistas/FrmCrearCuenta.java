...
public class FrmCrearCuenta extends JFrame {
    ...
    public FrmCrearCuenta() {
        ...
        JLabel lbl1 = new JLabel("ID del Cliente (Dueño):"); lbl1.setForeground(textoColor);
        JLabel lbl2 = new JLabel("<html>Cree un Número de Cuenta<br>(Ej: 123456789):</html>"); lbl2.setForeground(textoColor);
        JLabel lbl3 = new JLabel("Saldo Inicial ($):"); lbl3.setForeground(textoColor);
        ...
        panel.add(lbl1); panel.add(txtIdCliente);
        panel.add(lbl2); panel.add(txtNumCuenta);
        panel.add(lbl3); panel.add(txtSaldo);
        panel.add(btnCrear); panel.add(btnRegresar);
