...
public class MenuPrincipal extends JFrame {
    ...
    public MenuPrincipal() {
        ...
        // Ventana para eliminar cuentas (asegúrate de tener FrmEliminarCuenta.java creado)
        JButton btnEliminarC = crearBotonElegante("🗑️ 7. Cancelar Cuenta", colorBotones, colorTexto);
